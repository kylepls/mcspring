package org.springframework.boot.loader.test.other.stats;
...
public class simplefactionsaddon extends JavaPlugin {
    ...
    @SpringBootApplication(scanBasePackages = {"test.other.stats"})
