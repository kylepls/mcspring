...
import `in`.kyle.mcspring.command.execution.SimpleMethodInjection
...
open class CommandExecutorFactory(
...
//                }
                ...
                throw RuntimeException("Could not invoke method ${method.name}", exception)
            }
            true
        }
    }
